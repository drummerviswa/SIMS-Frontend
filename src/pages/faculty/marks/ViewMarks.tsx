...
import ViewSubCard from "../../../components/common/ViewSubCard";
type Subject = {
  degName: string;
  branchName: string;
...
export default function ViewMarks() {
  ...
  // Cards that will be displayed in the view marks page
  // View by assessment, view by student, view by subject
  return (
