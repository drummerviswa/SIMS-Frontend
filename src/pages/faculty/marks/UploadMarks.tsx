  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[34rem] gap-8 px-4 py-8">
      {!loading && regulation === "R2019" ? (
        <div className="flex lg:flex-row flex-col gap-6 p-4 w-full h-full">
          <Link
        ...
        <div className="flex lg:flex-row flex-col gap-6 p-4 w-full h-full">
          <Link
            to={`/faculty/marks/upload/${subCode}/${batchName}/assignment`}
            className="group flex flex-col items-center justify-center w-full h-full"
          >
            <div className="file relative w-60 h-40 cursor-pointer origin-bottom [perspective:1500px] z-50">
              <div className="work-5 bg-yellow-600 w-full h-full origin-top rounded-2xl rounded-tl-none group-hover:shadow-[0_20px_40px_rgba(0,0,0,.2)] transition-all ease duration-300 relative after:absolute after:content-[''] after:bottom-[99%] after:left-0 after:w-20 after:h-4 after:bg-amber-600 after:rounded-t-2xl before:absolute before:content-[''] before:-top-[15px] before:left-[75.5px] before:w-4 before:h-4 before:bg-amber-600 before:[clip-path:polygon(0_35%,0%_100%,50%_100%);]" />
